      ...
      <React.Fragment>
        <div className="hold-transition skin-blue sidebar-mini">
            ...
            <header className="main-header">
              ...
              <div className="navbar navbar-static-top" style={{ height: 62 }}>
                ...
                <NavLink to="/adminPage">
                  <div
                    className="navbar-custom-menu pull-right"
                    style={{ color: "white" }}
                  >
          ...
          <div
            ...
            style={{ height: 650}}
          > */}
          <aside className="main-sidebar" style={{ height: 1500, width: 230 }}>
              ...
              >
                ...
                <li className=" ">
                  <Link to="/suggestedbooks">
                    <i className="fa fa-book"></i> <span>Suggested Books</span>
                  </Link>
                </li>
                <li className=" ">
                  <Link to="/booksReturned">
                    <i className="fa fa-book"></i> <span>Books Returned</span>
                  </Link>
                </li>
