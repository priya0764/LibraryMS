        ...
        <div className="user-panel">
            <div className="pull-left image">
                <NavLink to="http://demo.greensoftbd.xyz/greenlms/v2.2/profile/index">
                    <img src="http://demo.greensoftbd.xyz/greenlms/v2.2/uploads/member/default.png" className="img-circle"  class="kiki" alt=""/>
                </NavLink>
            </div>
            <div  class="kiki1">
                <p >Admin</p>
...
<section className="content">
    <div className="box box-mytheme" class="kiki3">
        <img src={image} alt=""></img>
        <div class="kiki5">
        <p><h2>The only thing you absolutely have to know is the location of the library</h2></p>
        </div>
