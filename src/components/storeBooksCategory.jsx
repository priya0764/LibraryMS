          ...
          <div className="container ml-5 mr-5">
            ...
            <div className="row mt-4">
              <div className="col-sm-2">
                <div className="single-book-category">
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/mystery" className="book-category-title">
                      Mystery
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-sm-2">
                <div className="single-book-category">
                  <div className="book-category-image">
                    <Link to="/category/books/thriller">
                      <img
                        className="book-category-thumbnail-image"
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/thriller" className="book-category-title">
                      Thriller
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-sm-2">
                <div className="single-book-category">
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/horror" className="book-category-title">
                      Horror
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-sm-2">
                <div className="single-book-category">
                  <div className="book-category-image">
                    <Link to="/category/books/sciencefiction">
                      <img
                        className="book-category-thumbnail-image"
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/sciencefiction" className="book-category-title">
                      Science Fiction
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-sm-2">
                <div className="single-book-category">
                  <div className="book-category-image">
                    <Link to="/category/books/adventure">
                      <img
                        className="book-category-thumbnail-image"
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/adventure" className="book-category-title">
                      Adventure
                    </Link>
                  </div>
                </div>
              ...
              <div className="col-sm-2">
                <div className="single-book-category">
                  ...
                  <div className="book-category-content">
                    <Link to="/category/books/fantasy" className="book-category-title mr-5">
                      Fantasy
                    </Link>
                  </div>
                </div>
