...
class UpdateSuggestedBooks extends Component {
  constructor(props) {
    ...
    this.changeSuggested_DateHandler =
      this.changeSuggested_DateHandler.bind(this);
  ...
  updateSuggestedBooks = (e) => {
    ...
    SuggestedBooksService.updateSuggestedBooks(
      suggestedBooks,
      this.state.id
    ).then((res) => {
                ...
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      onChange={this.changePublicationsHandler}
                    />
                  </div>
                  <div className="form-group">
                  ...
                  <div className="form-group">
                    ...
                    <input
                      ...
                      name=""
                      className="form-control"
                      value={this.state.suggested_date}
                      onChange={this.changeSuggested_DateHandler}
                    />
                  </div>
                  <div className="form-group">
                    <label>Status:</label>
                  ...
                  <button
                    ...
                    onClick={this.updateSuggestedBooks}
                  >
                    {" "}
                    Save
                  </button>
