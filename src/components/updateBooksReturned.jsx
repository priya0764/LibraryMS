...
class UpdateBooksReturned extends Component {
  constructor(props) {
    ...
    this.changePenalty_StatusHandler =
      this.changePenalty_StatusHandler.bind(this);
  ...
  updateBooksReturned = (e) => {
    ...
    BooksReturnedService.updateReturnedBooks(this.state.id, returned).then(
      (res) => {
              ...
              <div className="card-body">
                <form>
                  ...
                  <div className="form-group">
                    ...
                    <input
                      placeholder="returnedDate"
                      name="returnedDate"
                      className="form-control"
                      value={this.state.returnedDate}
                      onChange={this.changeReturnedDateHandler}
                    />
                  </div>
                  <div className="form-group">
                    <label>DelayedDays:</label>
                    <input
                      placeholder="DelayedDays"
                      name="DelayedDays"
                      className="form-control"
                      value={this.state.delayedDays}
                      onChange={this.changeDelayedDaysHandler}
                    />
                  </div>
                  <div className="form-group">
                    <label>Penalty:</label>
                    <input
                      ...
                      onChange={this.changePenaltyHandler}
                    />
                  </div>
                  <div className="form-group">
                    <label>Penalty_Status:</label>
                    <input
                      placeholder="Penalty_Status"
                      name="Penalty_Status"
                      className="form-control"
                      value={this.state.penalty_Status}
                      onChange={this.changePenalty_StatusHandler}
                    />
                  </div>
                  <button
                    className="btn btn-success"
                    onClick={this.updateBooksReturned}
                  >
                    {" "}
                    Save
                  </button>
